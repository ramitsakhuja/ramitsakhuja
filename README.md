...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=200&section=header&text=Ramit+Sakhuja&fontSize=70&fontColor=fff&fontAlignY=38&desc=Data+Analytics+%7C+Visualization+%7C+Business+Insights&descAlignY=58&descSize=18" width="100%" />
...
<img src="https://raw.githubusercontent.com/TheDudeThatCode/TheDudeThatCode/master/Assets/Developer.gif" width="320" alt="Developer GIF"/>
...
```mermaid
flowchart LR
    A[🗄️ Raw Data] --> B[🧹 Clean & Transform]
    B --> C[🔍 Explore & Analyze]
    C --> D[🤖 Model & Predict]
    ...
    style A fill:#1a1a2e,stroke:#6E96F7,color:#fff
    style B fill:#1a1a2e,stroke:#A78BFA,color:#fff
    style C fill:#1a1a2e,stroke:#34D399,color:#fff
    style D fill:#1a1a2e,stroke:#F59E0B,color:#fff
    style E fill:#1a1a2e,stroke:#EC4899,color:#fff
    style F fill:#1a1a2e,stroke:#6E96F7,color:#fff
    style G fill:#1a1a2e,stroke:#34D399,color:#fff
```
